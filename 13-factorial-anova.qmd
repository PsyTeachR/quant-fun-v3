...
3. Create a new Quarto document and give it a sensible title describing the chapter, such as `13 Factorial ANOVA`. Delete everything below line 6 so you have a blank file to work with and save the file in your `Chapter_13_F_ANOVA` folder. 
...
Copy and paste the text and inline code below into **white-space** in your Quarto document. If you saved all the descriptives, model, and contrasts using the same object names as us, this should render. 
