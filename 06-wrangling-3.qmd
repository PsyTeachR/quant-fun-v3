...
After this chapter, you will be ready for the first data analysis journey chapter: [Analysis Journey 1: Data Wrangling](#journey-01-wrangling). This is where you can test the skills you have developed so far on a more independent task as a bridge between the core chapters and your assessments. If you want *even* more practice, you can explore the wrangling section of our [Data Analysis Journeyse](https://psyteachr.github.io/analysis_journeys/){target="_blank"} book which provides further practice opportunities with less structure than these chapters.
